...
API_ID = int(environ.get('API_ID', '20438694'))
API_HASH = environ.get('API_HASH', '97de1430c7d6fc190135b3002a621001')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7730278795').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002839983607'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002625346421').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002890947301')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002593306131')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://meeradevi22103:JND5XFvuKp6ED5j9@cluster0.stjhoge.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'cf65fef0003ff03c15d5c907f0647a479fc29060')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+sYYpPgyyOq03Mzhl') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
